// Vendored from swan-io/lake (types/react-native/index.d.ts): react-native-web style and
// accessibility props that @types/react-native doesn't declare. Required to typecheck
// web-only styles and lake 18's CSS-variable design tokens (spacings, radii, shadows).
